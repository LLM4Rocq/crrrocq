...
"""
Step 9: Only keep entries containing at least on correct search query per target.
"""
...
def is_valid(entry, dictionary, top_k=10):
    ...
    for block_prev, block_next, block_next_next in zip(blocks, blocks[1:], blocks[2:]):
        ...
        for score, element, fqn in block_prev['search_result']:
            # TODO: old artifact, need to merge all notation to have coherent keys
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', default='export/output/steps/step_8/result.json')
    ...
    parser.add_argument('--output', default='export/output/steps/step_9/')
